...
# Data sources — de-identified release dataset (PII removed)
#   SRC1: item-level claim/award amounts    (sheet: 判决书赔偿项目汇总)
#   SRC2: legal-context features & extracts (sheets: 原告责任信息 / 伤残等级提取 / 赔偿差距原因)
SRC1 = PROJECT_ROOT / "data" / "compensation_items_summary.xlsx"
SRC2 = PROJECT_ROOT / "data" / "extraction_results.xlsx"
